...
Source: ../../sequential_pipeline.py

DO NOT EDIT THIS FILE MANUALLY
Regenerate by running: asya flow compile ../../sequential_pipeline.py
"""
...
def start_sequential_pipeline(payload: dict):
    ...
    _next.append(resolve("trading_analyst"))
    _next.append(resolve("execution_planner"))
    _next.append(resolve("risk_evaluator"))
