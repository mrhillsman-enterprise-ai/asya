...
def start_parallel_sectioning(payload: dict):
    ...
    _next.append(resolve("router_parallel_sectioning_line_44_seq"))
    yield "SET", ".route.next[:0]", _next
    yield payload

def router_parallel_sectioning_line_44_seq(payload: dict):
    """Router for control flow and payload mutations"""
    p = payload
    _next = []
    p['analysis'] = list(await asyncio.gather(sentiment_analyzer(p['text']), topic_extractor(p['text']), entity_recognizer(p['text'])))
    _next.append(resolve("aggregator"))
