...
Source: ../../mutations_before_after_handler.py

DO NOT EDIT THIS FILE MANUALLY
Regenerate by running: asya flow compile ../../mutations_before_after_handler.py
"""
...
def start_mutations_before_after_handler_flow(payload: dict) -> dict:
...
def router_mutations_before_after_handler_flow_line_11_seq(payload: dict) -> dict:
    """Router for control flow and payload mutations"""
    p = payload
    with open(f"{_MSG_ROOT}/route/next") as _f:
        _next_tail = _f.read().splitlines()
...
def end_mutations_before_after_handler_flow(payload: dict) -> dict:
