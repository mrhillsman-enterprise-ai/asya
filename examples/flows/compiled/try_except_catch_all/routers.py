...
Source: ../../try_except_catch_all.py

DO NOT EDIT THIS FILE MANUALLY
Regenerate by running: asya flow compile ../../try_except_catch_all.py
"""
...
def start_resilient_pipeline(payload: dict) -> dict:
...
def router_resilient_pipeline_line_5_seq(payload: dict) -> dict:
...
def router_resilient_pipeline_line_8_seq(payload: dict) -> dict:
    """Router for control flow and payload mutations"""
    p = payload
    with open(f"{_MSG_ROOT}/route/next") as _f:
        _next_tail = _f.read().splitlines()
...
def router_resilient_pipeline_line_2_try_enter_0(payload: dict) -> dict:
    ...
    with open(f"{_MSG_ROOT}/headers/_on_error", "w") as _f:
        _f.write(resolve("router_resilient_pipeline_line_2_except_dispatch_0"))
...
def router_resilient_pipeline_line_2_try_exit_0(payload: dict) -> dict:
...
def router_resilient_pipeline_line_2_except_dispatch_0(payload: dict) -> dict:
    ...
    if "ValueError" in _all_types:
        ...
        _next.append(resolve("router_resilient_pipeline_line_5_seq"))
    else:
        import shutil as _shutil_exc; _shutil_exc.rmtree(f"{_MSG_ROOT}/status/error", ignore_errors=True)
...
def end_resilient_pipeline(payload: dict) -> dict:
    """Exitpoint for flow 'resilient_pipeline'"""
    with open(f"{_MSG_ROOT}/route/next", "w") as _f:
        _f.write("")
    return payload
