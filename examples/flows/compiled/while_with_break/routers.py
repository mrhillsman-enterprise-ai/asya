...
def start_while_with_break_flow(payload: dict) -> dict:
...
def router_while_with_break_flow_line_14_if(payload: dict) -> dict:
...
def router_while_with_break_flow_line_12_seq(payload: dict) -> dict:
    """Router for control flow and payload mutations"""
    p = payload
    with open(f"{_MSG_ROOT}/route/next") as _f:
        _next_tail = _f.read().splitlines()
...
def end_while_with_break_flow(payload: dict) -> dict:
