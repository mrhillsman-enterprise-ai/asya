...
def start_if_empty_branches_flow(envelope: dict) -> dict:
...
def router_if_empty_branches_flow_line_10_if(envelope: dict) -> dict:
...
def end_if_empty_branches_flow(envelope: dict) -> dict:
