...
Source: ../../if_all_empty_branches.py

DO NOT EDIT THIS FILE MANUALLY
Regenerate by running: asya flow compile ../../if_all_empty_branches.py
"""
...
def start_if_empty_branches_flow(payload: dict) -> dict:
    ...
    _next.append(resolve("router_if_empty_branches_flow_line_10_if"))
    with open(f"{_MSG_ROOT}/route/next", "w") as _f:
        _f.write("\n".join(_next + _next_tail))
    return payload

def router_if_empty_branches_flow_line_10_if(payload: dict) -> dict:
...
def end_if_empty_branches_flow(payload: dict) -> dict:
    """Exitpoint for flow 'if_empty_branches_flow'"""
    with open(f"{_MSG_ROOT}/route/next", "w") as _f:
        _f.write("")
    return payload
