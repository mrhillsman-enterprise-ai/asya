...
def start_complex_combined_flow(payload: dict) -> dict:
    ...
    _next.append(resolve("router_complex_combined_flow_line_11_if"))
    with open(f"{_MSG_ROOT}/route/next", "w") as _f:
        _f.write("\n".join(_next + _next_tail))
    return payload

def router_complex_combined_flow_line_25_if(payload: dict) -> dict:
...
def router_complex_combined_flow_line_20_if(payload: dict) -> dict:
    """Router for control flow and payload mutations"""
    p = payload
    with open(f"{_MSG_ROOT}/route/next") as _f:
        _next_tail = _f.read().splitlines()
    ...
    if p['skip_even'] and p['i'] % 2 == 0:
        _next.append(resolve("router_complex_combined_flow_line_17_loop_back_0"))
    else:
...
def router_complex_combined_flow_line_17_loop_back_0(payload: dict) -> dict:
...
def router_complex_combined_flow_line_17_while_0(payload: dict) -> dict:
    """Router for control flow and payload mutations"""
    p = payload
    with open(f"{_MSG_ROOT}/route/next") as _f:
        _next_tail = _f.read().splitlines()
...
def router_complex_combined_flow_line_30_if(payload: dict) -> dict:
    """Router for control flow and payload mutations"""
    p = payload
    with open(f"{_MSG_ROOT}/route/next") as _f:
        _next_tail = _f.read().splitlines()
...
def router_complex_combined_flow_line_28_if(payload: dict) -> dict:
    """Router for control flow and payload mutations"""
    p = payload
    with open(f"{_MSG_ROOT}/route/next") as _f:
        _next_tail = _f.read().splitlines()
...
def router_complex_combined_flow_line_15_if(payload: dict) -> dict:
    """Router for control flow and payload mutations"""
    p = payload
    with open(f"{_MSG_ROOT}/route/next") as _f:
        _next_tail = _f.read().splitlines()
...
def router_complex_combined_flow_line_11_if(payload: dict) -> dict:
    """Router for control flow and payload mutations"""
    p = payload
    with open(f"{_MSG_ROOT}/route/next") as _f:
        _next_tail = _f.read().splitlines()
...
def end_complex_combined_flow(payload: dict) -> dict:
