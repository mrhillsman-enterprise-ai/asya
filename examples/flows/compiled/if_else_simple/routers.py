...
Regenerate by running: asya flow compile ../../if_else_simple.py
"""
...
def start_if_else_simple_flow(envelope: dict) -> dict:
    """Entrypoint for flow 'if_else_simple_flow'"""
    r = envelope['route']
    c = r['current']

    r['actors'][c+1:c+1] = [resolve("handler_setup"), resolve("router_if_else_simple_flow_line_10_if")]
    r['current'] = c + 1
    return envelope

def router_if_else_simple_flow_line_10_if(envelope: dict) -> dict:
...
def end_if_else_simple_flow(envelope: dict) -> dict:
    """Exitpoint for flow 'if_else_simple_flow'"""
    return envelope
