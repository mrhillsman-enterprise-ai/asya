...
def start_if_else_simple_flow(payload: dict) -> dict:
    ...
    _next.append(resolve("router_if_else_simple_flow_line_10_if"))
    with open(f"{_MSG_ROOT}/route/next", "w") as _f:
        _f.write("\n".join(_next + _next_tail))
    return payload

def router_if_else_simple_flow_line_10_if(payload: dict) -> dict:
...
def end_if_else_simple_flow(payload: dict) -> dict:
