...
def start_if_else_simple_flow(message: dict) -> dict:
...
def router_if_else_simple_flow_line_10_if(message: dict) -> dict:
...
def end_if_else_simple_flow(message: dict) -> dict:
