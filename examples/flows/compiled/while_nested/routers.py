...
def start_while_nested_flow(payload: dict) -> dict:
...
def router_while_nested_flow_line_16_seq(payload: dict) -> dict:
...
def router_while_nested_flow_line_12_seq(payload: dict) -> dict:
    """Router for control flow and payload mutations"""
    p = payload
    with open(f"{_MSG_ROOT}/route/next") as _f:
        _next_tail = _f.read().splitlines()
...
def router_while_nested_flow_line_11_while_0(payload: dict) -> dict:
    """Router for control flow and payload mutations"""
    p = payload
    with open(f"{_MSG_ROOT}/route/next") as _f:
        _next_tail = _f.read().splitlines()
...
def end_while_nested_flow(payload: dict) -> dict:
