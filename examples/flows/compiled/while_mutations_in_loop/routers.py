...
def start_while_mutations_in_loop_flow(payload: dict) -> dict:
...
def router_while_mutations_in_loop_flow_line_17_seq(payload: dict) -> dict:
...
def router_while_mutations_in_loop_flow_line_13_seq(payload: dict) -> dict:
    """Router for control flow and payload mutations"""
    p = payload
    with open(f"{_MSG_ROOT}/route/next") as _f:
        _next_tail = _f.read().splitlines()
...
def end_while_mutations_in_loop_flow(payload: dict) -> dict:
