...
def start_if_elif_else_flow(payload: dict) -> dict:
...
def router_if_elif_else_flow_line_12_if(payload: dict) -> dict:
...
def router_if_elif_else_flow_line_10_if(payload: dict) -> dict:
    """Router for control flow and payload mutations"""
    p = payload
    with open(f"{_MSG_ROOT}/route/next") as _f:
        _next_tail = _f.read().splitlines()
...
def end_if_elif_else_flow(payload: dict) -> dict:
