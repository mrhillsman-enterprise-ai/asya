...
Regenerate by running: asya flow compile ../../sequential_with_class.py
"""
...
def start_class_instantiation_flow(envelope: dict) -> dict:
...
def end_class_instantiation_flow(envelope: dict) -> dict:
