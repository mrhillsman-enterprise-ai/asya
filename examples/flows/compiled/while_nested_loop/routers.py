...
def start_nested_loop_flow(payload: dict) -> dict:
...
def router_nested_loop_flow_line_16_seq(payload: dict) -> dict:
...
def router_nested_loop_flow_line_12_while_0(payload: dict) -> dict:
    """Router for control flow and payload mutations"""
    p = payload
    with open(f"{_MSG_ROOT}/route/next") as _f:
        _next_tail = _f.read().splitlines()
...
def end_nested_loop_flow(payload: dict) -> dict:
