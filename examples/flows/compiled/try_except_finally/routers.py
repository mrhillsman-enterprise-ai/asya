...
def start_resource_pipeline(payload: dict) -> dict:
...
def router_resource_pipeline_line_3_try_enter_0(payload: dict) -> dict:
    ...
    with open(f"{_MSG_ROOT}/headers/_on_error", "w") as _f:
        _f.write(resolve("router_resource_pipeline_line_3_except_dispatch_0"))
...
def router_resource_pipeline_line_3_try_exit_0(payload: dict) -> dict:
...
def router_resource_pipeline_line_3_except_dispatch_0(payload: dict) -> dict:
...
def router_resource_pipeline_line_3_reraise_0(payload: dict) -> dict:
