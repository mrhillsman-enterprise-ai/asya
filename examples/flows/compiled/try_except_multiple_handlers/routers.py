...
def start_data_pipeline(payload: dict) -> dict:
...
def router_data_pipeline_line_6_seq(payload: dict) -> dict:
...
def router_data_pipeline_line_9_seq(payload: dict) -> dict:
    """Router for control flow and payload mutations"""
    p = payload
    with open(f"{_MSG_ROOT}/route/next") as _f:
        _next_tail = _f.read().splitlines()
...
def router_data_pipeline_line_12_seq(payload: dict) -> dict:
    """Router for control flow and payload mutations"""
    p = payload
    with open(f"{_MSG_ROOT}/route/next") as _f:
        _next_tail = _f.read().splitlines()
...
def router_data_pipeline_line_2_try_enter_0(payload: dict) -> dict:
    ...
    with open(f"{_MSG_ROOT}/headers/_on_error", "w") as _f:
        _f.write(resolve("router_data_pipeline_line_2_except_dispatch_0"))
...
def router_data_pipeline_line_2_try_exit_0(payload: dict) -> dict:
...
def router_data_pipeline_line_2_except_dispatch_0(payload: dict) -> dict:
...
def router_data_pipeline_line_2_reraise_0(payload: dict) -> dict:
...
def end_data_pipeline(payload: dict) -> dict:
