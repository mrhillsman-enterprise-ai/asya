...
Source: ../../fanout_literal.py

DO NOT EDIT THIS FILE MANUALLY
Regenerate by running: asya flow compile ../../fanout_literal.py
"""
...
def start_analysis_flow(payload: dict) -> dict:
...
def fanout_analysis_flow_line_10(payload: dict):
    ...
    with open(f"{_MSG_ROOT}/route/next", "w") as _f:
        _f.write("\n".join([_agg, resolve("merge_analysis")] + _next_tail))
...
def end_analysis_flow(payload: dict) -> dict:
    """Exitpoint for flow 'analysis_flow'"""
    with open(f"{_MSG_ROOT}/route/next", "w") as _f:
        _f.write("")
    return payload
