...
Source: ../../async_conditional.py

DO NOT EDIT THIS FILE MANUALLY
Regenerate by running: asya flow compile ../../async_conditional.py
"""
...
def start_content_pipeline_flow(payload: dict) -> dict:
...
def router_content_pipeline_flow_line_14_if(payload: dict) -> dict:
...
def router_content_pipeline_flow_line_12_if(payload: dict) -> dict:
    """Router for control flow and payload mutations"""
    p = payload
    with open(f"{_MSG_ROOT}/route/next") as _f:
        _next_tail = _f.read().splitlines()
...
def end_content_pipeline_flow(payload: dict) -> dict:
