...
Source: ../../fanout_gather.py

DO NOT EDIT THIS FILE MANUALLY
Regenerate by running: asya flow compile ../../fanout_gather.py
"""
...
def start_async_research_flow(payload: dict) -> dict:
    ...
    _next.append(resolve("fanout_async_research_flow_line_11"))
    with open(f"{_MSG_ROOT}/route/next", "w") as _f:
        _f.write("\n".join(_next + _next_tail))
    return payload

def fanout_async_research_flow_line_11(payload: dict):
    ...
    _agg = resolve("fanin_async_research_flow_line_11")
    ...
    with open(f"{_MSG_ROOT}/route/next", "w") as _f:
        _f.write("\n".join([_agg, resolve("post_processor")] + _next_tail))
...
def end_async_research_flow(payload: dict) -> dict:
    """Exitpoint for flow 'async_research_flow'"""
    with open(f"{_MSG_ROOT}/route/next", "w") as _f:
        _f.write("")
    return payload
