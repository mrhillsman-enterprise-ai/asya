...
Source: ../../while_simple.py

DO NOT EDIT THIS FILE MANUALLY
Regenerate by running: asya flow compile ../../while_simple.py
"""
...
def start_while_simple_flow(message: dict) -> dict:
    """Entrypoint for flow 'while_simple_flow'"""
    r = message['route']
    c = r['current']

    r['actors'][c+1:c+1] = [resolve("handler_init"), resolve("router_while_simple_flow_line_11_while_0")]
    r['current'] = c + 1
    return message

def router_while_simple_flow_line_12_seq(message: dict) -> dict:
...
def router_while_simple_flow_line_11_loop_back_0(message: dict) -> dict:
    ...
    _next.append(resolve("router_while_simple_flow_line_11_while_0"))

    r['actors'][c+1:c+1] = _next
    r['current'] = c + 1
    return message

def router_while_simple_flow_line_11_while_0(message: dict) -> dict:
    """Router for control flow and payload mutations"""
    p = message['payload']
    r = message['route']
    c = r['current']
    ...
    if p['i'] < p['max_iterations']:
        _next.append(resolve("router_while_simple_flow_line_12_seq"))
        _next.append(resolve("router_while_simple_flow_line_11_loop_back_0"))
    else:
...
def end_while_simple_flow(message: dict) -> dict:
