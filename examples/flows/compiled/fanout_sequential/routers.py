...
Source: ../../fanout_sequential.py

DO NOT EDIT THIS FILE MANUALLY
Regenerate by running: asya flow compile ../../fanout_sequential.py
"""
...
def start_multi_stage_flow(payload: dict) -> dict:
...
def fanout_multi_stage_flow_line_12(payload: dict):
    ...
    _slices = []
    for r in p['research']:
        _slices.append((resolve("review_agent"), r))
...
def end_multi_stage_flow(payload: dict) -> dict:
