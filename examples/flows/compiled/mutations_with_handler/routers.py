...
Source: ../../mutations_with_handler.py

DO NOT EDIT THIS FILE MANUALLY
Regenerate by running: asya flow compile ../../mutations_with_handler.py
"""
...
def start_mutations_with_handler_flow(payload: dict) -> dict:
    """Entrypoint for flow 'mutations_with_handler_flow'"""
    with open(f"{_MSG_ROOT}/route/next") as _f:
        _next_tail = _f.read().splitlines()
    _next = []

    _next.append(resolve("router_mutations_with_handler_flow_line_9_seq"))
    with open(f"{_MSG_ROOT}/route/next", "w") as _f:
        _f.write("\n".join(_next + _next_tail))
    return payload

def router_mutations_with_handler_flow_line_13_seq(payload: dict) -> dict:
...
def router_mutations_with_handler_flow_line_9_seq(payload: dict) -> dict:
    """Router for control flow and payload mutations"""
    p = payload
    with open(f"{_MSG_ROOT}/route/next") as _f:
        _next_tail = _f.read().splitlines()
...
def end_mutations_with_handler_flow(payload: dict) -> dict:
