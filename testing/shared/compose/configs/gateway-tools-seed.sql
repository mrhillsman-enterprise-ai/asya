...
-- a2a_enabled=true for tools exercised by A2A integration tests.

INSERT INTO tools (name, actor, route_next, description, parameters, timeout_sec, progress, mcp_enabled, a2a_enabled) VALUES
('test_echo', 'test-echo', '{}',
