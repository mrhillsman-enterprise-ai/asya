...
Source: ../../sample_flow.py

DO NOT EDIT THIS FILE MANUALLY
Regenerate by running: asya flow compile ../../sample_flow.py
"""
...
def start_sample_flow(payload: dict) -> dict:
...
def router_sample_flow_line_4_seq(payload: dict) -> dict:
...
def router_sample_flow_line_8_seq(payload: dict) -> dict:
    """Router for control flow and payload mutations"""
    p = payload
    with open(f"{_MSG_ROOT}/route/next") as _f:
        _next_tail = _f.read().splitlines()
...
def router_sample_flow_line_3_if(payload: dict) -> dict:
    """Router for control flow and payload mutations"""
    p = payload
    with open(f"{_MSG_ROOT}/route/next") as _f:
        _next_tail = _f.read().splitlines()
...
def end_sample_flow(payload: dict) -> dict:
