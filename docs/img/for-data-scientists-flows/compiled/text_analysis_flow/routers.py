...
def start_text_analysis_flow(payload: dict) -> dict:
...
def router_text_analysis_flow_line_14_seq(payload: dict) -> dict:
...
def router_text_analysis_flow_line_11_if(payload: dict) -> dict:
    """Router for control flow and payload mutations"""
    p = payload
    with open(f"{_MSG_ROOT}/route/next") as _f:
        _next_tail = _f.read().splitlines()
...
def router_text_analysis_flow_line_18_seq(payload: dict) -> dict:
    """Router for control flow and payload mutations"""
    p = payload
    with open(f"{_MSG_ROOT}/route/next") as _f:
        _next_tail = _f.read().splitlines()
...
def router_text_analysis_flow_line_9_if(payload: dict) -> dict:
    """Router for control flow and payload mutations"""
    p = payload
    with open(f"{_MSG_ROOT}/route/next") as _f:
        _next_tail = _f.read().splitlines()
...
def end_text_analysis_flow(payload: dict) -> dict:
